...
def parse_args():
    ...
    parser.add_argument(
        '-c', '--config-path', type=str, default="yolox-s-detection-for-demo.yaml",
...
if __name__ == '__main__':        
    ...
    for model_config_path in config_path_list:
        try:
            ...
            exported_program = export(torch_model, (sample_input,))
            
            output_path = Path(args.output_dir) / f"{model_config_path.stem}.pt2"
